...
public class Principal1 extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(this, "No es un archivo válido");
        }
        // TODO add your handling code here:
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try {
            ...
            jTextEmpleados.setText("");
            jTextEmpleados.setText(archivo1.getArbol().imprimirRecursivo(0, 0));
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "No es un jefe válido");
        }
        // TODO add your handling code here:
...
//        for (int i = 0; i < m.length; i++) {
//            for (int j = 0; j < m.length; j++) {
//                if (m[i][j] != INF && m[j][i] != INF && m[i][j] != m[j][i]) {
//                    for (int k = 0; k < aristas2D.size(); k++) {
//                        if (aristas2D.get(k).contieneNodo(i) && aristas2D.get(k).contieneNodo(j)) {
//                        } else {
//                            aristas2D.add(new Arista2D(nodos2D.get(i), nodos2D.get(j), Color.black, m[i][j]));
//                        }
//                    }
